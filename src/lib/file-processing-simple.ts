// File processing service with simplified exports
...
export async function processFile(
  ...
  const document = await prisma.document.create({
    data: {
      title: generateTitle(fileName, content),
      content,
      fileName,
      fileType,
  ...
  // Generate embeddings for the document (disabled for testing)
  console.log('Vector embeddings temporarily disabled for testing')
...
export async function getUserDocuments(sessionId: string): Promise<ProcessedDocument[]> {
...
export async function getDocumentStats(): Promise<{ totalDocuments: number; totalSize: number; publicDocuments: number }> {
...
export async function testPDFProcessing(filePath: string): Promise<string> {
